...
(function() {
	...
	APP.data.addItem(data, 'react.ico', 'https://reactjs.org/docs/hello-world.html', 'React', 'React Documentation.');
	APP.model.add(data);
	...
	APP.data.addItem(data, 'react.ico', 'https://reactjs.org/docs/forms.html', 'React Forms', 'React Forms');
	APP.model.add(data);
