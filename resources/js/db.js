...
APP.db = {
	"Blogs & Communities": {
		...
		"items": [
			{
				"image": "./resources/images/logos/johnvincent.png",
			...
			{
				"image": "./resources/images/logos/stackoverflow.png",
			...
			{
				"image": "./resources/images/logos/smashingmagazine.png",
			...
			{
				"image": "./resources/images/logos/codrops.png",
			...
			{
				"image": "./resources/images/logos/sitepoint.jpg",
			...
			{
				"image": "./resources/images/logos/webdesignerdepot.png",
			...
			{
				"image": "./resources/images/logos/frontendfront.png",
	...
	"Bootstrap": {
		...
		"items": [
			{
				"image": "./resources/images/logos/bootstrap.ico",
			...
			{
				"image": "./resources/images/logos/developer-telerik.ico",
			...
			{
				"image": "./resources/images/logos/tutorialzine.png",
			...
			{
				"image": "./resources/images/logos/bootsnipp.png",
	...
	"Chrome": {
		...
		"items": [
			{
				"image": "./resources/images/logos/chrome-web-store.png",
	...
	"Cloud": {
		...
		"items": [
			...
			{
				"image": "./resources/images/logos/digitalocean.png",
	...
	"CMS": {
		...
		"items": [
			{
				"image": "./resources/images/logos/ghost.ico",
			...
			{
				"image": "./resources/images/logos/aaaa-no-favicon.png",
			...
			{
				"image": "./resources/images/logos/formspree.png",
				"h3_href": "https://formspree.io/",
				"h3_text": "Form Spree",
				"p_text": "Email forwarding from a post"
			},
			{
				"image": "./resources/images/logos/handlebars.png",
				"h3_href": "http://handlebarsjs.com/",
				"h3_text": "Handlebars",
				"p_text": "Build semantic templates"
			},
			{
				"image": "./resources/images/logos/rouge.ico",
	...
	"Colors and Tools": {
		...
		"items": [
			{
				"image": "./resources/images/logos/material-io.png",
			...
			{
				"image": "./resources/images/logos/flatuicolors.png",
			...
			{
				"image": "./resources/images/logos/flatiucolors.ico",
			...
			{
				"image": "./resources/images/logos/materialpalette.jpg",
			...
			{
				"image": "./resources/images/logos/colorhunt.gif",
			...
			{
				"image": "./resources/images/logos/lolcolors.svg",
			...
			{
				"image": "./resources/images/logos/uigradients.png",
			...
			{
				"image": "./resources/images/logos/paletton.png",
			...
			{
				"image": "./resources/images/logos/0to255.png",
	...
	"Content Delivery Network CDNs": {
		...
		"items": [
			{
				"image": "./resources/images/logos/cdnjs.ico",
				"h3_href": "https://cdnjs.com/",
				"h3_text": "CDN",
				"p_text": "Search from thousands of libraries"
			},
			{
				"image": "./resources/images/logos/google-cloud.ico",
	...
	"CSS3": {
		...
		"items": [
			{
				"image": "./resources/images/logos/mdn.png",
			...
			{
				"image": "./resources/images/logos/tutplus.png",
			...
			{
				"image": "./resources/images/logos/animatecss.png",
			...
			{
				"image": "./resources/images/logos/responsivegrid.png",
			...
			{
				"image": "./resources/images/logos/css-guide.png",
			...
			{
				"image": "./resources/images/logos/1stwebdesigner.ico",
			...
			{
				"image": "./resources/images/logos/purecss.ico",
			...
			{
				"image": "./resources/images/logos/semantic-ui.png",
	...
	"Deployment": {
		...
		"items": [
			{
				"image": "./resources/images/logos/webpack.ico",
			...
			{
				"image": "./resources/images/logos/webpack-analyse.png",
	...
	"Developer Tools": {
		...
		"items": [
			{
				"image": "./resources/images/logos/git.ico",
			...
			{
				"image": "./resources/images/logos/bitbucket.ico",
				"h3_href": "https://bitbucket.org/",
				"h3_text": "Bitbucket",
				"p_text": "Git repositories"
			},
			{
				"image": "./resources/images/logos/git-tower.ico",
				"h3_href": "https://www.git-tower.com/blog/git-cheat-sheet/",
				"h3_text": "Git Cheat Sheet",
				"p_text": "Git Cheat Sheet"
			},
			{
				"image": "./resources/images/logos/sourcetree.ico",
			...
			{
				"image": "./resources/images/logos/caniuse.png",
	...
	"Diagram Tools": {
		...
		"items": [
			...
			{
				"image": "./resources/images/logos/creately.png",
	...
	"Documentation Tools": {
		...
		"items": [
			{
				"image": "./resources/images/logos/google-docs.ico",
				"h3_href": "https://docs.google.com/",
				"h3_text": "Google Docs",
				"p_text": "Create and edit documents online, for free."
			},
			{
				"image": "./resources/images/logos/gitbook.ico",
			...
			{
				"image": "./resources/images/logos/lumio.ico",
	...
	"Editor Tools": {
		...
		"items": [
			{
				"image": "./resources/images/logos/visual-studio-code.ico",
	...
	"Find Design Inspiration": {
		...
		"items": [
			{
				"image": "./resources/images/logos/dribbble.png",
			...
			{
				"image": "./resources/images/logos/calltoidea.png",
			...
			{
				"image": "./resources/images/logos/colourlovers.ico",
	...
	"Fonts and Typography Tools": {
		...
		"items": [
			{
				"image": "./resources/images/logos/googlefonts.png",
			...
			{
				"image": "./resources/images/logos/fontsquirrel.jpg",
			...
			{
				"image": "./resources/images/logos/creativebloq.jpeg",
			...
			{
				"image": "./resources/images/logos/myfonts.png",
	...
	"Game Assets": {
		...
		"items": [
			{
				"image": "./resources/images/logos/itch-io.ico",
	...
	"HTML5 Resources": {
		...
		"items": [
			...
			{
				"image": "./resources/images/logos/css-tricks-3.png",
	...
	"Icons and Tools": {
		...
		"items": [
			{
				"image": "./resources/images/logos/ionicons.png",
				"h3_href": "http://ionicons.com/",
				"h3_text": "Ionicons",
				"p_text": "#1 icon font, 100% free even for commercial usage."
			},
			{
				"image": "./resources/images/logos/fontawesome.ico",
			...
			{
				"image": "./resources/images/logos/flaticon.png",
	...
	"Images and Videos": {
		...
		"items": [
			...
			{
				"image": "./resources/images/logos/randomuser.png",
			...
			{
				"image": "./resources/images/logos/coverr.png",
			...
			{
				"image": "./resources/images/logos/startupstock.png",
	...
	"JavaScript Resources": {
		...
		"items": [
			{
				"image": "./resources/images/logos/facebook.ico",
			...
			{
				"image": "./resources/images/logos/hubspot.png",
			...
			{
				"image": "./resources/images/logos/keycodes.jpg",
			...
			{
				"image": "./resources/images/logos/js-patterns.png",
			...
			{
				"image": "./resources/images/logos/es6-compat.png",
			...
			{
				"image": "./resources/images/logos/momentjs.png",
	...
	"Node": {
		...
		"items": [
			{
				"image": "./resources/images/logos/nodejs.png",
			...
			{
				"image": "./resources/images/logos/expressjs.png",
			...
			{
				"image": "./resources/images/logos/nodemailer.ico",
			...
			{
				"image": "./resources/images/logos/passportjs.png",
				"h3_href": "http://passportjs.org/",
				"h3_text": "Passport",
				"p_text": "Authentication middleware for NodeJS"
			},
			{
				"image": "./resources/images/logos/jwt.png",
	...
	"NoSQL": {
		...
		"items": [
			{
				"image": "./resources/images/logos/mongodb.ico",
				"h3_href": "https://www.mongodb.com/",
				"h3_text": "MongoDB",
				"p_text": "MongoDB"
			},
			{
				"image": "./resources/images/logos/mongoChef.png",
			...
			{
				"image": "./resources/images/logos/mLab-logo-dark.svg",
	...
	"Planning, Testing, Optimization and Deployment": {
		...
		"items": [
			{
				"image": "./resources/images/logos/w3c.png",
			...
			{
				"image": "./resources/images/logos/favicongenerator.png",
			...
			{
				"image": "./resources/images/logos/websiteplanet.png",
			...
			{
				"image": "./resources/images/logos/usabilitychecklist.ico",
			...
			{
				"image": "./resources/images/logos/nibbler.png",
			...
			{
				"image": "./resources/images/logos/wave.ico",
				"h3_href": "http://wave.webaim.org/",
				"h3_text": "Wave",
				"p_text": "Web Accessibility Evaluation Tool"
			},
			{
				"image": "./resources/images/logos/googleanalytics.png",
			...
			{
				"image": "./resources/images/logos/woorank.png",
	...
	"React": {
		...
		"items": [
			{
				"image": "./resources/images/logos/react.ico",
			...
			{
				"image": "./resources/images/logos/react-training.png",
			...
			{
				"image": "./resources/images/logos/redux.ico",
			...
			{
				"image": "./resources/images/logos/redux-form.png",
			...
			{
				"image": "./resources/images/logos/reactd3.png",
			...
			{
				"image": "./resources/images/logos/material-ui.ico",
			...
			{
				"image": "./resources/images/logos/materialdesignicons.png",
			...
			{
				"image": "./resources/images/logos/styled-components.png",
	...
	"Sass": {
		...
		"items": [
			{
				"image": "./resources/images/logos/sass-lang.ico",
				"h3_href": "http://sass-lang.com/",
				"h3_text": "SASS",
				"p_text": "Sass is a CSS extension language."
			},
			{
				"image": "./resources/images/logos/thesassway.png",
			...
			{
				"image": "./resources/images/logos/zerosixthree.ico",
	...
	},
{
		...
		"items": [
			{
				"image": "./resources/images/logos/html5.ico",
